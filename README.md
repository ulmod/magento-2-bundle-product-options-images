...
[Magento 2 Bundle Product Options Image - Popup - Collapse](https://www.ulmod.com/magento-2-bundle-items.html) is a Magento 2 extension that allows you to show Magento 2 bundle product options images in the frontend. Display bundle option SKU, short description, and main description in a popup. Expand and collapse bundle product options in the front end.

<a href="https://www.ulmod.com/magento-2-bundle-items.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Show images of bundle products options in the storefront
* Support all bundle options input: Drop-down, Radio buttons, Checkbox, and Multiple Select
* Ability to display bundle products options images of type multiple-select in a slider. 
* Display bundle options name, SKU, short-description, and main description in a popup 
* Ability to set the size of bundle option image to display in frontend
* Mobile friendly 
* Flexible settings. Easy to configure and use. 
